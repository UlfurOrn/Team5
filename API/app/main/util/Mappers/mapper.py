class Mapper():
    """ 
        ...
        __str__ returns a string of the objects for testing pourposes
        ...
        to_sql_insert retruns a touble of strings that can be used in an sql insert query
    """
    def __str__(self):
    ...
    def to_sql_insert(self):
        """ Retruns a touble of strings that can be used in an sql insert query """
        keys_str = "("
        values_str = "("
        for key, value in self.__dict__.items():
            if value != None:
